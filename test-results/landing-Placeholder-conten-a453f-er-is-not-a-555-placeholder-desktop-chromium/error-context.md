...
- Name: landing.spec.js >> Placeholder content that ships live >> phone number is not a 555 placeholder
- Location: tests\landing.spec.js:538:3

# Error details

```
Error: page ships with a non-dialable 555 phone number
